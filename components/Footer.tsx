...
<footer>
  <div className="footer-inner">
    <div className="footer-top">
      <ul className="fnav">
        <li className="nav-button sp"><button><Link href="https://www.fiika-inc.co.jp/contact/"><a>Contact</a></Link></button></li>
        <li className="footer-logo"><img src="/assets/img/img-logo-02.png" alt="fiika inc." /></li>
        <li className="footer-arrow dropdown sp"><Link href="https://www.fiika-inc.co.jp/"><a>Top page</a></Link></li>
        ...
        <li className="has-child footer-arrow dropdown"><a>Works</a>
          <ul>
            ...
            <li className="dropdown-list"><Link href="https://www.fiika-inc.co.jp/blog/tag/works/"><a>制作実績・コンサルティング実績</a></Link></li>
          </ul>
        </li>
        ...
        <li className="has-child footer-arrow dropdown"><a>Blog &amp; Topics</a>
          <ul>
            ...
            <li className="dropdown-list"><Link href="https://www.fiika-inc.co.jp/blog/"><a>ブログ＆トピックス一覧</a></Link></li>
          </ul>
        </li>
        <li className="footer-arrow dropdown sp"><Link href="https://www.fiika-inc.co.jp/access/"><a>Access Map</a></Link></li>
        <li className="nav-button pc"><button><Link href="https://www.fiika-inc.co.jp/contact/"><a>Contact</a></Link></button></li>
      </ul>
    </div>
    <div className="footer-bottom">
      <p className="privacypolicy">
      <Link href="https://www.fiika-inc.co.jp/privacypolicy/"><a style={{marginRight: '2rem'}}>プライバシーポリシー</a></Link>
      <Link href="https://www.fiika-inc.co.jp/Security/"><a>情報セキュリティ方針</a></Link></p>
